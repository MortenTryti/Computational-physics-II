...
class Sampler:
    ...
    def _sample(self, nsamples, chain_id, seed=None):
        ...
        self.alg.state.n_accepted_up = 0
        self.alg.state.n_accepted_down = 0
        ...
        """
        #breakpoint()
        #print("n_accepted_up" , self.alg.state.n_accepted_up)
        #print("n_accepted_down" , self.alg.state.n_accepted_down)
        ...
        #print("n_accepted" , self.alg.state.n_accepted)
